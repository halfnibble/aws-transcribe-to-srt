...
# Format and return a string that contains the converted number of seconds
# into WebVTT format
...
def writeTranslationToWebVTT(
    transcript, sourceLangCode, targetLangCode, WebVTTFileName
):
    ...
    translation = translateTranscript(
        transcript, sourceLangCode, targetLangCode
    )
...
def getPhrasesFromTranscript(transcript):
    ...
    # from the Transcribe service. However,  if you only have the translation
    # of the transcript, then you should call getPhrasesFromTranslation instead
