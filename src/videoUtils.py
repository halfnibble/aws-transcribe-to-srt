...
def createVideo(
    ...
    # Note that if we need to use an alternate audio track, the last parm
    # should = False
    ...
    # Create a lambda function that will be used to generate the subtitles for
    # each sequence in the SRT
